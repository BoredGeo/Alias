...
The end of the notebook contains a short discussion about how to represent measurements of offset features for ramdom sampling and includes some examples of common distributions. This is intended for people who are interested in using the random sampling to model slip-rate based on earthquake record.
